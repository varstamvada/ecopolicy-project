...
with open('pullmemberbill.csv', mode='r') as file:
    ...
    for row in reader:
        ...
        url = f"https://api.congress.gov/v3/member/{bioguide_id}/cosponsored-legislation?format=json&offset=0&limit=250&api_key={api_key}"
        ...
        if response.status_code == 200:
            ...
            with open(f'cosponsor_{bioguide_id}.json', 'w') as outfile:
